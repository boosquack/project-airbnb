...
const BookingsPage = () => {
  ...
  const { bookings, status: bookingsStatus } = useSelector((state: RootState) => state.bookings);
  const { listings, status: listingsStatus } = useSelector((state: RootState) => state.listings);
